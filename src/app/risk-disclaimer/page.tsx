    ...
    >
      <div className="rounded-[1.75rem] border border-stone-200 bg-white/90 px-8 py-8 shadow-[0_20px_60px_-40px_rgba(28,25,23,0.18)]">
        <div className="prose prose-stone max-w-none text-sm leading-7">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">Trading involves substantial risk</h2>
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">Guardrail does not guarantee prevention of losses</h2>
          <p className="mt-2 text-stone-700">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">Manual Mode does not block trades at the broker</h2>
          <p className="mt-2 text-stone-700">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">Broker-level enforcement depends on broker API support</h2>
          <p className="mt-2 text-stone-700">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">Destructive actions require explicit consent</h2>
          <p className="mt-2 text-stone-700">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">Connection reliability</h2>
          <p className="mt-2 text-stone-700">
          ...
          <h2 className="mt-6 text-base font-semibold text-stone-950">User responsibility</h2>
          <p className="mt-2 text-stone-700">
