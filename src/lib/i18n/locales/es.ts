...
export const es: BotLocale = {
  ...
  factual: {
    markets: { FUTURES: "Futuros", US_EQUITIES: "Acciones", FOREX: "Forex", CRYPTO: "Cripto" },
    sessions: {
      Globex: "Globex", "Pre-Market": "Preamercado", "NYSE / NASDAQ": "NYSE / NASDAQ",
      "After-Hours": "Fuera de horario", Asia: "Asia", London: "Londres", NY: "NY",
      Forex: "Forex", "24/7": "24/7",
    },
    marketOpen: "{name} está abierto. Cierra {time}.",
    marketOpenSession: "{name} está abierto. {session}. Cierra {time}.",
    marketOpenNoClose: "{name} está abierto.",
    marketClosed: "{name} está cerrado.",
    marketClosedNextOpen: "{name} está cerrado. Abre {time}.",
    noMarketData: "No hay datos de horario de mercado disponibles.",
    noLimitsConfigured: "No hay límites configurados.",
    dailyLossLimitLine: "Límite de pérdida diaria: {amount}.",
    maxTradesLine: "Máximo de operaciones: {limit}.",
    stopAfterLossesLine: "Detener tras {limit} pérdidas consecutivas.",
    lossRemainingUsed: "{amount} restantes en el límite diario.",
    lossRemainingFull: "{amount} disponibles — sin pérdidas aún.",
    tradesCountLine: "Operaciones: {count} de {limit}.",
    consecutiveLossesLine: "Pérdidas consecutivas: {count} de {limit}.",
    dailyLossLimitHit: "Límite de pérdida diaria alcanzado. Operaciones detenidas por hoy.",
    maxTradesHit: "Se alcanzaron {limit} operaciones hoy. No más entradas.",
    maxTradesHitGeneric: "Límite diario de operaciones alcanzado. No más entradas.",
    consecutiveLossesHit: "{limit} pérdidas consecutivas — límite alcanzado. Para ahora.",
    consecutiveLossesHitGeneric: "Límite de pérdidas consecutivas alcanzado. Para ahora.",
    sessionEnded: "La sesión de hoy ha terminado. Espera hasta mañana.",
    guardianLocked: "Cuenta bloqueada. Operaciones suspendidas.",
    preNewsBlock: "Operaciones bloqueadas — evento económico importante.",
    tradingBlocked: "Las operaciones están detenidas ahora mismo.",
    noTradingData: "No hay datos de estado de trading disponibles.",
    tradingAllowed: "Puedes operar.",
    tradesRemaining: "{count} operaciones restantes.",
    lossBudgetRemaining: "{amount} de presupuesto de pérdida restante.",
  },
};
